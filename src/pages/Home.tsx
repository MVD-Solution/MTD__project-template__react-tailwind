...
import { useStates as useDarkModeStates } from '@store/models/darkMode';
import { useActions as useDarkModeActions } from '@store/models/darkMode';
...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="flex gap-2 flex-wrap md:flex-nowrap mb-2 md:w-1/2 w-full">
        <button
